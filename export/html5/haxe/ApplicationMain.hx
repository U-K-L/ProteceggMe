...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Protecegg-Me", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Protecegg-Me", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Protecegg-Me";
		app.meta["name"] = "Protecegg-Me";
